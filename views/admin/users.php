...
$users = array_merge(
    $controller->getUserByRole('admin'),
    $controller->getUserByRole('employer'),
    $controller->getUserByRole('recruiter'),
    $controller->getUserByRole('seeker')
);
?>
<!DOCTYPE html>
<html>
    ...
    <div class="app-shell">
        ...
        <main class="main">
            <div class="topbar">
                <div>
                    <h1>Users</h1>
                    <p class="muted">All user accounts</p>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php foreach($users as $user){ ?>
                            <tr>
                                ...
                                <td><span class="badge badge-blue"><?php echo htmlspecialchars($user['role']); ?></span></td>

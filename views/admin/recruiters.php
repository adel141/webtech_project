...
$recruiters = $controller->getUserByRole('recruiter');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    <div class="app-shell">
        <aside class="sidebar">
            ...
            <a class="nav-link active" href="recruiters.php">Recruiters</a>
        ...
        <main class="main">
            <div class="topbar">
                <div>
                    <h1>Recruiters</h1>
                    <p class="muted">Review and manage recruiter accounts</p>
                </div>
            </div>
            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tbody>
                        <?php foreach($recruiters as $user){ ?>
                            <tr>
